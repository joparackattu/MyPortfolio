...
export default function Contact() {
  ...
  const socialLinks = [
    ...
    {
      name: 'Email',
      href: 'mailto:sajijo14@gmail.com',
      icon: (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">sajijo14@gmail.com</span>
              </div>
            </div>
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="text-gray-400 hover:text-blue-400 transition-colors duration-200 p-2 glass rounded-lg hover:scale-110 transition-transform"
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg font-semibold text-white hover:scale-105 transition-transform duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                disabled={submitted}
              >
