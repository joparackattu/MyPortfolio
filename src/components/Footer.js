...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-white/10 glass backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <Link href="/" className="text-xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent mb-4 inline-block">
             JO ...
            </Link>
            <p className="text-gray-400 text-sm leading-relaxed">
              Full-Stack Developer passionate about creating innovative solutions and exploring AI technologies.
            </p>
          </motion.div>
        ...
        >
          <p className="text-gray-400 text-sm">
            © {currentYear} Jo Saji. All rights reserved.
          </p>
        </motion.div>
      </div>
    </footer>
